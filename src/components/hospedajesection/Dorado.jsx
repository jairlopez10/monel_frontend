...
const Dorado = () => {
  return (
    <>
        ...
        <div className="div-section">
          <img src="/gif1b.gif" alt="" />
          <h4>¡DIVERSION PARA ADULTOS Y NIÑOS!</h4>
          <p>¡Juega con la <span className="font-bold">Bolirana, Ping Pong o Volleyball</span> en grupo !</p>
        </div>
        <div className="div-section">
          <img src="/gif1e.gif" alt="" />
          <h4>¡ESPACIO PARA HASTA 23 PERSONAS!</h4>
          <p>¡Duerme en las <span className="font-bold">11 camas semidobles</span> totalmente comodo!</p>
        </div>
        <div className="div-section">
          <img src="/gif1d.gif" alt="" />
          <h4>¡ASADO EN FAMILIA!</h4>
        ...
        <div className="div-section">
          ...
          <div className="lista-incluye">
            <ul >
              <li>4 Habitaciones (11 Camas semidobles)</li>
              <li>3 Baños con Ducha</li>
              <li>Piscina</li>
              <li>Jacuzzi</li>
              <li>Bolirana</li>
              <li>Mesa Ping Pong</li>
              <li>Cancha Volleyball</li>
              <li>BBQ o Parrilla</li>
